...
def main(cfg: DictConfig):    
    ...
    # 创建IDM/WM模型
    idm, _, fm = utils.create_dynamics_models_flow(cfg.model)
    ...
    def train_step():
        ...
        vq_loss, vq_perp = idm.label_onehorizon_flowsam(batch)
    ...
    def test_step():
        ...
        _, eval_metrics = utils.eval_latent_idmflow(cfg.model, eval_data, idm)
