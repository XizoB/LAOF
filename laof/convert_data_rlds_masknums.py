...
class HDF5ToTFRecordConverter:
    ...
    def load_demo_from_hdf5(self, file_path, demo_key):
        ...
        with h5py.File(file_path, 'r') as f:
            ...
            data = {
                ...
                'mask_nums': np.array(demo_group['mask_nums'])  # 添加mask_nums
            }
    ...
    def create_tf_example(self, sample):
        ...
        feature = {
            ...
            'mask_nums': self._bytes_feature(tf.io.serialize_tensor(sample['mask_nums'].astype(np.int8))),  # 添加mask_nums
        }
...
def parse_tf_example(example_proto):
    ...
    feature_description = {
        ...
        'mask_nums': tf.io.FixedLenFeature([], tf.string),  # 添加mask_nums
    }
    ...
    parsed_example['mask_nums'] = tf.io.parse_tensor(example['mask_nums'], out_type=tf.int8)  # 添加mask_nums
