...
def main(cfg: DictConfig):    
    ...
    # 创建IDM/WM模型
    idm, wm = utils.create_dynamics_models_onehorizon_wmflow_shared(cfg.model)
    ...
    def train_step():
        ...
        wm_loss, flow_loss = wm.label_flow(batch)
        loss = wm_loss + vq_loss + flow_loss
    ...
    def test_step():
        ...
        logger(step, wm_loss_test=wm_loss, flow_loss_test=flow_loss, global_step=step * cfg.stage1.bs, **eval_metrics)
